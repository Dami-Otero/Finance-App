...
const Homescreen = ({ navigation }) => {
  ...
  return (
    <KeyboardAvoidingView
      ...
      keyboardVerticalOffset={80} // You can adjust this value
    >
      <View style={styles.innerContainer}>
        ...
        <View style={styles.lowerButtonContainer}>
          ...
          <TouchableOpacity style={styles.lowerButton} onPress={() => navigation.navigate('LiveMarketUpdates')}>
            <Text style={styles.lowerButtonText}>Live Market Updates</Text>
          </TouchableOpacity>
        </View>
      </View>
    </KeyboardAvoidingView>
